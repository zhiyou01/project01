...
<header>
	<div class="container top_bar clearfix">
		<img src="../projectimg/logo.png" alt="智游">
		<div id="tele">
		...
		<div class="container clearfix">
			...
			<div id="user_bar">
				<a>
						...
						<img id="avatar" src="../projectimg/avatar_lg.png" alt="" "="">
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    ...
                    <li><a href="updatephoto">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="updatepwd">密码安全</a></li>
                </ul>
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            
                                <img src="http://localhost:8080/VideoProject/" width="200px;">
                            

                            
                        </div>
                        <div class="profile_ifo_area">
                            <form id="userdata" method="post" action="updateuser">
                                <input name="id" value="${user.id}" type="hidden">
                                <div class="form_group">
                                    <span class="dd">昵　称：</span><input name="name" value="${user.name}" type="text" >
                                
                                </div>
                                <div class="form_group">
                                    <span class="dd">性　别：</span>
                                    <input id="man"  type="radio" value="${user.sex}" name="sex" checked><label for="man">男</label>
                                    <input id="woman" type="radio" value="${user.sex}" name="sex"><label for="woman">女</label>
                                </div>
                                <div class="form_group">
                                ...
                                <div class="form_group">
                                    ...
                                    <input name="address" value="${user.address}" id="address" type="hidden">
                                </div>
                                <div class="form_submit dd">
                                    <input onclick="return commitForm();" value="保　存" type="submit">
                                    <a onclick="formRest()">重置</a>
                                </div>
