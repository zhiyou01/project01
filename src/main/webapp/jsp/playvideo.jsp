...
<div class="intro">
	<div class="container">
		<div class="v-intro">
			<div class="left">
				<video id="videoPlayer" src="http://vod.zhiyou100.com/gkk/h5/c1/01.mp4" class="video-js vjs-default-skin" controls="controls" poster="../projectimg/02.jpg" data-setup="{}" height="280" width="627">
				</video>
			</div>
			...
			<div class="right">
				...
				<div class="avatar">
					<span style="background-image: url(../projectimg/zgd.jpg)"></span>
	...
	<div class="container">
		<p class="title">目录</p>
			...
			<div class="chapter">
				...
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">433</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">562</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">365</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">596</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">332</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">1374</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">284</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">1692</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">266</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">1699</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">236</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">409</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">232</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">2112</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">206</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">1997</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">218</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">1569</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">223</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">2179</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../projectimg/count.png" alt="">244</span>
					<span class="duration"><img src="../projectimg/player.png" alt="">2134</span>
				</div>
			</div>
		...
		<li class="mt25">
			...
			<ul id="foo_icon">
				...
				<li class="erwei">
					<br>
					<div>
						<img class="weixin" src="../projectimg/a.png" alt="" draggable="false">
						<img class="weibo" src="../projectimg/a_002.png" alt="" draggable="false">
					</div>
				</li>
			</ul>
		</li>
