...
<header>
	...
	<menu>
		<div class="container clearfix">
			...
			<div id="user_bar">
				<a><img id="avatar" src="${pageContext.request.contextPath }/projectimg/avatar_lg.png"></a>
                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                           <img id="avatar" width="150px;" src="${pageContext.request.contextPath }/projectimg/avatar_lg.png">
		                </div>
